...
void main() {
  ...
  f_color = (
    0.01121809948984034 * texture(sampler2D(t_input, s_input), vec2(coords.x - offset6, coords.y)) +
    0.02631938726462541 * texture(sampler2D(t_input, s_input), vec2(coords.x - offset5, coords.y)) +
    0.05230252219485956 * texture(sampler2D(t_input, s_input), vec2(coords.x - offset4, coords.y)) +
    0.08823977317441423 * texture(sampler2D(t_input, s_input), vec2(coords.x - offset3, coords.y)) +
    0.12660489194589866 * texture(sampler2D(t_input, s_input), vec2(coords.x - offset2, coords.y)) +
    0.15466448679206415 * texture(sampler2D(t_input, s_input), vec2(coords.x - offset1, coords.y)) +
