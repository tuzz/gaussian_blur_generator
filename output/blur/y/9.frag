...
void main() {
  ...
  gl_FragColor = (
    0.01979265894569135 * texture2D(u_texture, vec2(coords.x, coords.y - offset4)) +
    0.0633074017748216 * texture2D(u_texture, vec2(coords.x, coords.y - offset3)) +
    0.13994267760750037 * texture2D(u_texture, vec2(coords.x, coords.y - offset2)) +
    0.21657795344017916 * texture2D(u_texture, vec2(coords.x, coords.y - offset1)) +
